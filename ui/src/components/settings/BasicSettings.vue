...
<script setup lang="ts">
    ...
    pendingSettings.saveDefaultAction = localStorage.getItem(storageKeys.SAVE_DEFAULT_ACTION) || saveDefaultActions.SAVE
    ...
    function onSaveDefaultActionChange(value: string) {
        pendingSettings.saveDefaultAction = value
        checkForChanges()
    }
